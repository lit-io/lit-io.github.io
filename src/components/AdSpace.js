...
const nestURL = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTu0h4Wn8AlwCFE6f9Q9Q1CCNNgzUg4W3_AjcCp7iVfvJT2eD35'
          ...
          >
            ...
            {this.state.products.map((product, idx) => {
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card style={{ padding: "10px", maxWidth: "300" }} key={idx}>
                  <CardContent style={{ display: "flex", padding: "10px" }}>
                    <div>
                      <img
                        src={product.imgUrl}
                        style={{ height: "5em", width: "auto", padding: "3px" }}
                      />
                    </div>
